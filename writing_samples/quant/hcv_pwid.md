...
Linear estimation: In the 10 reports, the pooled stage-constant estimate of fibrosis progression (F0→F4), described in table 1, was 0.117 units per year (range 0.070, 0.232). Using this estimate, time to CC was 34 years for an individual with chronic HCV. 

Nonlinear estimation: MML estimation was performed for 6 of the 10 reports containing sufficient data on the fibrosis staging distribution and person-time of the sample. Table 3 presents the pooled stage-specific transition rates among this subset; the FPRs were the following: F0→F1, 0.128 (CI 0.080, 0.176); F1→F2, 0.059 (CI 0.035, 0.082); F2→F3, 0.078 (CI 0.056, 0.100); and F3→F4, 0.116 (CI 0.070, 0.161). Based on this progression sequence, time to CC was 46 years. 
